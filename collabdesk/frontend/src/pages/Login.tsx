...
import { Eye, EyeOff, FolderKanban, ArrowRight, Loader2 } from 'lucide-react'
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate">
              ...
              <button onClick={() => navigateTo('/register')} className="text-primary font-medium hover:underline">
                Sign up
              </button>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => navigateTo('/forgot-password')} className="text-sm text-primary hover:underline">
                Forgot password?
              </button>
            </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-surface text-slate">Or continue with</span>
              </div>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg p-12 text-white">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex -space-x-3">
                {[1, 2, 3].map((i) => (
                  <div 
                    key={i} 
                    className="w-12 h-12 rounded-full bg-white/20 border-2 border-primary flex items-center justify-center text-lg font-medium"
                  >
          ...
          <blockquote className="text-2xl font-display font-medium mb-4">
            "CollabDesk transformed how our team works together. We ship faster and communicate better."
          </blockquote>
          <cite className="not-italic">
            <span className="font-semibold">Sarah Johnson</span>
            <span className="text-white/60"> — CEO at StartupXYZ</span>
          </cite>
        </div>
      </div>
    </div>
